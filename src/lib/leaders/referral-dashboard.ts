...
export function buildReferralDashboard(
  ...
  return {
    ...
    rootBadge: resolveReferralBadge(normalizedCode, eligibleRows, now),
...
function resolveReferralBadge(referralCode: string, rows: WaitlistReferralRow[], now: Date): "red" | "blue" | null {
