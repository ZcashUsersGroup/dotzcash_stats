...
} from "../lib/leaders/referral-dashboard.js";
...
test("buildReferralDashboard builds descendant depth and direct initiated counts", () => {
  const dashboard = buildReferralDashboard("root", rows, "all", new Date("2026-04-30T12:00:00.000Z"));
...
test("buildReferralDashboard filters unconfirmed descendants in confirmed scope", () => {
  const dashboard = buildReferralDashboard("root", rows, "confirmed", new Date("2026-04-30T12:00:00.000Z"));
...
test("buildReferralDashboard protects against cycles", () => {
  const dashboard = buildReferralDashboard("cycle", rows, "all", new Date("2026-04-30T12:00:00.000Z"));
...
test("buildReferralDashboard keeps canonical identity and surfaces the preferred root code", () => {
  ...
  const dashboard = buildReferralDashboard("root", aliasRows, "all", new Date("2026-04-30T12:00:00.000Z"));
